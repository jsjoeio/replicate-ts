...
const LoadingBtn = () => {
  return (
    <button
      type="button"
      className="inline-flex items-center px-6 py-2 font-semibold leading-6 text-sm shadow rounded-md text-white bg-indigo-500 hover:bg-indigo-400 transition ease-in-out duration-150 cursor-not-allowed"
      disabled
    >
      <svg
